...
開発ガイドライン作成を開始する前に、必ず以下のファイルを Read ツールで読み込んでください:

1. `./guides/implementation.md` — コーディング規約・実装パターンのガイド
2. `./guides/process.md` — Git運用・レビュー・自動化のプロセスガイド
3. `./template.md` — 開発ガイドラインのテンプレート（出力の雛形）
